...
const PixModal = ({ total, onClose, formData, cartItems, deliveryType }) => {
	...
	const pixKey = "+5548991691906";
	const merchantName = "Anderson josé oliveira";
	const merchantCity = "São José";
			...
			<Content>
				{paymentStep === "awaiting" ? (
					...
					<ConfirmedContainer>
						...
						<Text>
							Seu pedido foi recebido. Para agilizar, Estamos Verificando o comprovante de
							pagamento, Se possível envia-nos.
						</Text>
						<ButtonGroup>
